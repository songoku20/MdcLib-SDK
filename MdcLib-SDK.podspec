...
s.homepage         = 'https://github.com/songoku20/MdcLib-SDK.git'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'songoku20' => 'lesonle.bkhn.1993@gmail.com' }
s.source           = { :git => 'https://github.com/songoku20/MdcLib-SDK.git', :tag => s.version.to_s }
...
s.requires_arc        = true
s.source              = { :http => "https://github.com/songoku20/MdcLib-SDK/releases/download/#{s.version}/MdcLib.zip" }
s.platform            = :ios, '7.0'
